...
abstract class JHtmlString
{
	...
	public static function cutStrTitle($str, $number){
		$str = strip_tags($str);
		// Match English char
		$en = preg_match('/^[a-zA-Z]/', $str);
		// Match Chinese Characters, count number, return to $arrc
		$cn = preg_match_all("/([\x{4e00}-\x{9fa5}]){1}/u",$str,$arrc);
